...
const avataImages = new Array();
const imgTag = document.querySelector('.avata__sequence');

for (let i = 1; i < 48; i++) {
    avataImages.push(`./images/imagesequence/avata-${i}.png`);
}

const img = { crntImg: 0 };

let imageSequence = TweenMax.to(img, 0.5,
    {
        crntImg: avataImages.length - 1,
        roundProps: 'crntImg',
        immediateRender: true,
        onUpdate: function () {
            imgTag.setAttribute('src', avataImages[img.crntImg])
        }
    }
);
...
// 
// for (var i = 1; i < 92; i++) {
//     dataImages.push('./img/data-' + i + '.jpg');
// }
// 
// var dataObj = { curImg: 0 };
// 
// var tween = TweenMax.to(dataObj, 0.5,
//     {
//         curImg: dataImages.length - 1,
//         roundProps: "curImg",
//         immediateRender: true,
//         onUpdate: function () {
//             $("#data-logger").attr("src", dataImages[dataObj.curImg]);
//         }
//     }
// );
// 
...
// 
// var dataLogger = new ScrollMagic.Scene({
//     triggerElement: "#trigger-target",
//     duration: 6000,
//     triggerHook: 0
// })
//     .setPin("#trigger-target")
//     .setTween(tween)
//     .addIndicators({
//         name: '-PICPICPIC',
//         colorStart: 'red',
